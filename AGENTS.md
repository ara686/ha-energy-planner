...
- Use `DataUpdateCoordinator` for shared polling and call `async_config_entry_first_refresh` during setup.
...
- Keep `main` as the public stable release branch; merge `develop` to `main` only for release-ready code.
